...
class RankPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $adminUserPermission->rank_id = $ranks->where('club_id', $club->id)->where('name', '방장')->value('id');
        ...
        $teamLeaderPermission->rank_id = $ranks->where('club_id', $club->id)->where('name', '팀장')->value('id');
        ...
        $normalUserPrmission->rank_id = $ranks->where('club_id', $club->id)->where('name', '일반')->value('id');
        ...
        $honorUserPermission->rank_id = $ranks->where('club_id', $club->id)->where('name', '명예')->value('id');
